...
const getFormSchema = (t: any) => z.object({
  electricity: z.string().min(0, t("dashboard.electricityRequired")).default("0"),
  water: z.string().min(0, t("dashboard.waterRequired")).default("0"),
  gas: z.string().min(0, t("dashboard.gasRequired")).default("0"),
  month: z.number().min(1).max(12),
  year: z.number().min(2020).max(2030),
  readingDate: z.string().min(1, t("dashboard.dateRequired")),
  ...
  const addReadingMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: t("dashboard.successDescription"),
      });
      form.reset();
      ...
      <CardContent>
        ...
        <Dialog open={isAddReadingOpen} onOpenChange={setIsAddReadingOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>{t("dashboard.addReadingTitle")}</DialogTitle>
              <DialogDescription>
                {t("dashboard.addReadingDescription")}
              </DialogDescription>
            </DialogHeader>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("dashboard.selectMonth")}</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t("dashboard.selectYear")}</FormLabel>
                        <Select onValueChange={(value) => field.onChange(parseInt(value))} value={field.value?.toString()}>
                          <FormControl>
                            <SelectTrigger>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            type="number" 
                            step="0.01"
                            placeholder={t("dashboard.enterReadings")} 
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                      ...
                      <FormItem>
                        <FormLabel>
                          <div className="flex items-center gap-2">
                            ...
                            {t("dashboard.waterUsage").replace(" Usage", "")} (m³)
                          </div>
                        </FormLabel>
                        <FormControl>
                          <Input 
                      ...
                      <FormItem>
                        <FormLabel>
                          <div className="flex items-center gap-2">
                            ...
                            {t("dashboard.gasUsage").replace(" Usage", "")} (m³)
                          </div>
                        </FormLabel>
                        <FormControl>
                          <Input 
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <div className="text-xs text-blue-800 dark:text-blue-200 space-y-1">
                    {t("dashboard.dataSourcesDescription").split('\n').map((line, index) => (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("dashboard.readingDate")}</FormLabel>
                      <FormControl>
                ...
                <DialogFooter>
                  ...
                  <Button 
                    ...
                    disabled={addReadingMutation.isPending}
                  >
                    {addReadingMutation.isPending ? t("dashboard.saving") : t("dashboard.save")}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
