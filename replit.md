...
✓ Убрана школьная панель полностью:
  - Удалены все ссылки на School Panel из навигации
  - Убраны переводы schoolPanel из английской и русской локализации
  - Оставлены только региональные сравнения
✓ Исправлена проблема кэширования AI ассистента:
  - Добавлена очистка кэша перед инвалидацией
  - Теперь генерирует свежие рекомендации каждый раз
  - Добавлена кнопка очистки во вкладке Footprint
✓ Обновлена страница Footprint с акцентом на экологию:
  - Изменены тексты с фокусом на влияние на природу
  - Добавлены эмодзи и конкретные экологические показатели
  - Показывается реальный вред для климата и способы восстановления